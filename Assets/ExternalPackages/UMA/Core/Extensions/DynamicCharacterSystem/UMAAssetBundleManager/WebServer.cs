...
namespace UMA.AssetBundles
{
    public class SimpleWebServer
    {
        ...
        public SimpleWebServer(int port, string hostedFolder = "")
        {
            if (hostedFolder == "")
            {
        ...
        public static SimpleWebServer Start(int port, string hostedFolder = "")
        {
            if(Instance != null)
            {
                Instance.Stop();
            }
            Instance = new SimpleWebServer(port, hostedFolder);
            return Instance;
        }
