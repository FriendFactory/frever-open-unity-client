...
namespace UMA.Editors
{
    ...
    public class UMAGeneratorBaseEditor : Editor
    {
        ...
        SerializedProperty compressRenderTextureNormals;
        ...
        public void OnEnable()
        {
            ...
            compressRenderTextureNormals = serializedObject.FindProperty("compressRenderTextureNormals");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(compressRenderTextureNormals);
