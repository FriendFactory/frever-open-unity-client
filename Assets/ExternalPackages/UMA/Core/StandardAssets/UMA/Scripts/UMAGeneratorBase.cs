...
namespace UMA
{
	...
	public abstract class UMAGeneratorBase : MonoBehaviour
	{
		...
		[Tooltip("Convert normalmaps into a regular texture and compress it using PVRTC")]
		public bool compressRenderTextureNormals;
		...
		// Global variable to enable/disable the PVRTC compression
		public static bool compressRenderTexture;
