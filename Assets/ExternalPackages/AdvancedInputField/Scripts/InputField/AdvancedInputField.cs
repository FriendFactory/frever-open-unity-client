...
namespace AdvancedInputFieldPlugin
{
	...
	public enum KeyboardType { DEFAULT, ASCII_CAPABLE, DECIMAL_PAD, URL, NUMBER_PAD, PHONE_PAD, EMAIL_ADDRESS, NUMBERS_AND_PUNCTUATION, SOCIAL }
	...
	public class AdvancedInputField: Selectable, IPointerClickHandler, IPointerExitHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IUpdateSelectedHandler
	{
		...
		[EnumOrder(new int[] { 0, 1, 7, 3, 4, 5, 2, 6, 8 })]
		[SerializeField]
