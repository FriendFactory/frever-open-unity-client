...
{
    public class CommentOnVideoYouHaveCommentedOnCellView : UserBasedNotificationCellView<NotificationCommentOnVideoYouHaveCommentedOnItemView, NotificationCommentOnVideoYouHaveCommentedOnItemModel>
    {
