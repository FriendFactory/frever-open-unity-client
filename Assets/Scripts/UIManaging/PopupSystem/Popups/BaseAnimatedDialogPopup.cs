...
{
    public abstract class BaseAnimatedDialogPopup<TConfiguration>: BaseAnimatedInformationPopup<TConfiguration> where TConfiguration : DialogPopupConfiguration
    {
