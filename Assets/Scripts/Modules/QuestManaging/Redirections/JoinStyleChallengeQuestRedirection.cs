...
{
    [UsedImplicitly]
    public class JoinStyleChallengeQuestRedirection: IQuestRedirection
    {
        [Inject] private PageManager _pageManager;
        [Inject] private TipManager _tipManager;
        
        public string QuestType => QuestManaging.QuestType.JOIN_STYLE_CHALLENGE;
        public void Redirect()
        {
            ...
            {
                _pageManager.PageDisplayed -= OnPageDisplayed;
                _tipManager.ShowTipsById(TipId.QuestJoinStyleChallenge);
            }
        }
    }
}