...
namespace Modules.UserScenarios.Implementation.LevelCreation.NavigationSetups
{
    ...
    /// </summary>
    [UsedImplicitly]
    internal sealed class RemixStatesSetup : LevelCreationSetupBase
    {
        public override LevelCreationSetup Type => LevelCreationSetup.RemixSetup;

        public RemixStatesSetup(DiContainer diContainer) : base(diContainer)
        {
        }
        ...
        protected override IScenarioState[] SetupStates()
        {
            ...
            characterSelection.MoveNext = ResolveTransition<RemixCharacterSelectionToPostRecordEditorTransition>();
            ...
            return new IScenarioState[] { characterSelection, levelEditorState, postRecordEditorState, characterEditor, publish,
                publishFromGallery, previousPageExit, tasksExit, feedExit, profileExit, inboxPageExit, chatPageExit, exitToVideoMessageScenario };
        }
    }
}