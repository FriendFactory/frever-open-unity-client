...
{
    [UsedImplicitly]
    internal sealed class ExitScenarioFromLevelEditor: TransitionBase<ILevelCreationScenarioContext>
    {
        ...
        public ExitScenarioFromLevelEditor(ScenarioState scenarioState, ILevelManager levelManager, PopupManager popupManager)
        {
